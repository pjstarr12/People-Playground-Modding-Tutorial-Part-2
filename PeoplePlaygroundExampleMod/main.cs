...
ModAPI.Register(
    new Modification()
    {
        ...
        AfterSpawn = (Instance) =>
        {
            ...
            var flesh = ModAPI.LoadTexture("ExampleSkinHumanFlesh.png");// textures
            var bone = ModAPI.LoadTexture("ExampleSkinHumanBone.png");// textures
...
ModAPI.Register(
    new Modification()
    {
        ...
        NameOverride = "ExampleArmor",
        DescriptionOverride = "ExampleDescription",
        CategoryOverride = ModAPI.FindCategory("Misc."),
        ThumbnailOverride = ModAPI.LoadSprite("ExampleArmorThumb.png"),
        AfterSpawn = (Instance) =>
        { 
                        Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("ExampleArmor.png");
            ArmorBehaviour armor = Instance.AddComponent<ArmorBehaviour>();
            armor.stabResistance = 356748f;
            armor.armorPiece = "Head";
            armor.armorTier = 0;
            armor.otherSprite = ("ExampleArmor.pg");
            Instance.FixColliders();
        }  
    }
);
